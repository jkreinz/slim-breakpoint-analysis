...
# Script to run SLiM continuous simulation in parallel
# Usage: ./run_slim_continuous_parallel.sh <slim_script> [num_cpus] [num_iterations]
...
if [ $# -eq 0 ]; then
    ...
    echo "  breakpoint_continuous_additive_n200.slim"
    echo "  breakpoint_continuous_additive_n70.slim"
    echo "  breakpoint_continuous_recessive_n200.slim"
    echo ""
    echo "Examples:"
    echo "  $0 breakpoint_continuous_additive_n200.slim"
    echo "  $0 breakpoint_continuous_additive_n70.slim 8 50"
    echo "  $0 breakpoint_continuous_recessive_n200.slim 2 100"
    exit 1
fi
...
echo "========================================"
echo "SLiM Continuous Parallel Simulation Runner"
echo "========================================"
...
echo "│   └── ... (a VCF for each timepoint sampled)"
echo "├── iteration_2/"
echo "│   └── ..."
...
echo "Each iteration contains time-series VCF files (t000, t004, etc.)"
